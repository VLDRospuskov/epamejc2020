...
public class Strings {
    final static String ENTER_PLAYER_TYPE = "Choose opponent (h - human, c - computer):";
    final static String ENTER_PLAYER_TYPE_ERROR = "Incorrect player type. Enter player type again:";

    final static String INVITATION = "New player, enter your name:";
    ...
    final static String YOUR_SHIPS = ", your ships:";
    final static String YOUR_SHOTS = ", your shots before:";

    final static String COMPUTERS_SHOTS = "Computer shots before:";
    final static String COMPUTER_NEW_SHOT = "Computer shoots ";

    final static String ANSWER_DAMAGED = "Ship was damaged.";
    final static String ANSWER_KILLED = "Ship was killed.";
    final static String ANSWER_MISSED = "Shot missed.";
