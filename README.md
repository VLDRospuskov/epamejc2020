...
Create a traffic light that outputs a color signal.

At the input, the program takes the number of minutes from 0 to 10: 0-3 -> green, 4-5 -> yellow, 6-10 -> red.

- Example of work:
```
Out: Print integer value between 0 and 10 to change color of traffic light or 'exit' to close the program
In: 0
Out: Traffic Light : GREEN
In: 5
Out: Traffic Light : YELLOW
In: not a number
Out: Wrong Input!For input string: "not a number"
In: 10
Out: Traffic Light : RED
In: exit
Out: Bye-bye!
```
...
Create an array of arrays. The array is initialized with random characters based on user input.

- Example of work:
```
Out: Print number of rows:
In: 4
Out: Print number of columns:
In: 5
Out: Array  with random chars:
c n y f y 
q k h y q 
i l y m q 
i g w y q 
...
Create an array of arrays and fill it with random characters. Write 2 strategies that will form a string based on this array. Strategy A - works on the principle of * _ * _ *, and Strategy B - works on the principle of _ * _ * _. Strategy and dimension are entered by the user.
...
Write a program that will generate a pyramid.

- Example of work:
```
Out: Print number of levels:
In: 4
Out: Print order  "ascending" or "descending" :
In: ascending
Out: Print side "left" or "right" :
In: right
Out: Print filling char  :
In: $
Out: Your triangle :
...
Write a program that generates a new line based on the input. User enters line and option: odd / even

- Example of work:
```
Out: Print string:
In: 123456
Out: Print option of output "odd" or "even" :
In: odd
Out:
Output:
135
...
Write a program that generates a new line based on the input. User enters line and indexes.

- Example of work:
```
Out: Print not empty parent string:
In: abcdefg
Out: Your parent string: abcdefg
Print char position between 0 and 6 to add char to output or 'exit' to close the program
In: 0
Out: Input: 0 Output:a
In: 1
Out: Input: 1 Output:ab
In: 5
Out: Input: 5 Output:abf
In: exit
Out: Bye-bye
```
...
Write a program that swap characters in a string.User enters line and 2 indexes.

- Example of work:
```
Out: Print not empty parent string:
In: abcdef
Out: Your parent string: abcdef
Print two comma separated char position between 0 and 5 or 'exit' to close the program
In: 0, 1
Out: Output: bacdef
In: 5, 0
Out: Output: facdeb
...
Write a program that flips words, but leaves them in their original places.
...
- Example of work:
```
Out:How much Fibonacci numbers should be printed?
In: 5
Out: 0 1 1 2 3 Done.
```
...
- Example of work:
```
Out: Print number (only integer value) :
In: 5
Out: Print power (only integer value):
In: 3
Out: 5^(3) =125.0
```
...
Calculate the amount of digits in the entered number.
...
Create a file and fill it with text. Read the file using the BufferedReader and InputStreamReader, measure the reading time.
...
Create a program simulating banking processes. We have ATMs (each with its own account), a general bank account and people's cash .
...
Write a standard sea battle with two game options: person with person / person with a computer.
