package homeworks.homework7.stream_operations;
...
import static homeworks.homework7.stream_operations.GenerateData.getEmployees;
    ...
    Person findPersonWithLongestFullName() {
        ...
        return employees.stream()
                ...
                .max(Comparator.comparingInt(
                        (Person pOne) -> pOne.getFirstName().concat(pOne.getLastName()).length()))
