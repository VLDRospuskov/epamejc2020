...
public class Informer {
    ...
    public void run() {
        ...
        MyBiFunction<Integer, String, String> buildStr = (num, str) ->
                "Dear Mr. " + str + "! We inform you that your salary has been increased to " + num + " USD.";
    ...
    private String getStringFromFields(
            MyProducer<Integer> takeSalary, MyProducer<String> takeName,
            MyBiFunction<Integer, String, String> func
    ) {
        int salary = takeSalary.produce();
        String name = takeName.produce();
        return func.apply(salary, name);
    }
